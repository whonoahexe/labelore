...
- `/home/cinedise/gsd-lore/.planning/PROJECT.md` — authoritative source for the three forward-compatibility obligations, the read-only constraint, and the "works on any GSD project" requirement (HIGH confidence — primary project document).
